...
class Anggota extends OperatorController {
	...
	function import() {
		...
		$this->data['judul_sub'] = 'Anggota <a href="'.site_url('anggota').'" class="btn btn-sm btn-success">Kembali</a><br><span class="text-sm text-danger">Maksimal Data Anggota Dalam Sekali Import = 60 Data Anggota.</span>';
